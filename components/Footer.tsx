            ...
            <div className="flex gap-3">
              {[FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram, FaYoutube].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 bg-secondary-800 hover:bg-primary-500 rounded-full flex items-center justify-center transition-colors"
                >
                  <Icon size={16} />
                </a>
              ))}
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-secondary-300 hover:text-primary-500 transition-colors flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <FiMapPin className="text-primary-500 mt-1 flex-shrink-0" size={20} />
              ...
              <li className="flex items-center gap-3">
                <FiPhone className="text-primary-500 flex-shrink-0" size={20} />
                <span className="text-secondary-300">+254 123 456 789</span>
              </li>
              <li className="flex items-center gap-3">
                <FiMail className="text-primary-500 flex-shrink-0" size={20} />
                <span className="text-secondary-300">info@uhaiwashwise.org</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-secondary-800">
        <div className="container-main py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <Link href="#" className="text-secondary-400 hover:text-primary-500 transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-secondary-400 hover:text-primary-500 transition-colors">
              Terms of Service
